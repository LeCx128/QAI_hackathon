...
class PortfolioOptimization(OptimizationApplication):
    ...
    def __init__(
        ...
        Args:
            ...
            esg_scores: The ESG scores for each asset. If None, ESG optimization is disabled.
            roi_factor: The return appetite of the decision maker. If None, uses risk_factor for backward compatibility.
            esg_factor: The ESG preference of the decision maker. If None, ESG optimization is disabled.
    ...
    def to_quadratic_program(self) -> QuadraticProgram:
        ...
        if self._bounds:
            x = [
                mdl.integer_var(lb=self._bounds[i][0], ub=self._bounds[i][1], name=f"x_{i}")
        ...
        # Build the objective function with optional ESG term
        if self._esg_scores is not None and self._esg_factor != 0:
            ...
            # Backward compatibility: original formulation
